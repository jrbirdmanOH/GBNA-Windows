...
{
    partial class QuizFillInTheBlankPanel
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.getItRightRadioButton = new System.Windows.Forms.RadioButton();
			this.pictureTypeGroupBox = new System.Windows.Forms.GroupBox();
			this.allowCluesCheckBox = new System.Windows.Forms.CheckBox();
			...
			this.oneTryRadioButton = new System.Windows.Forms.RadioButton();
			...
			// 
			// getItRightRadioButton
			// 
			this.getItRightRadioButton.AutoSize = true;
			this.getItRightRadioButton.Location = new System.Drawing.Point(116, 19);
			this.getItRightRadioButton.Name = "getItRightRadioButton";
			this.getItRightRadioButton.Size = new System.Drawing.Size(134, 17);
			this.getItRightRadioButton.TabIndex = 1;
			this.getItRightRadioButton.TabStop = true;
			this.getItRightRadioButton.Text = "Try until you get it &right!";
			this.getItRightRadioButton.UseVisualStyleBackColor = true;
			// 
			// pictureTypeGroupBox
			// 
			...
			this.pictureTypeGroupBox.TabIndex = 6;
			this.pictureTypeGroupBox.TabStop = false;
			this.pictureTypeGroupBox.Text = "Picture Type";
			// 
			// allowCluesCheckBox
			// 
			this.allowCluesCheckBox.AutoSize = true;
			this.allowCluesCheckBox.Location = new System.Drawing.Point(5, 345);
			this.allowCluesCheckBox.Name = "allowCluesCheckBox";
			this.allowCluesCheckBox.Size = new System.Drawing.Size(335, 17);
			this.allowCluesCheckBox.TabIndex = 4;
			this.allowCluesCheckBox.Text = "Allo&w clues? (other media - e.g. other pictures, maps, videos, etc.)";
			this.allowCluesCheckBox.UseVisualStyleBackColor = true;
			// 
			// groupBox4
			// 
			...
			this.videoTypeGroupBox.TabIndex = 8;
			...
			this.soundTypeGroupBox.TabIndex = 7;
			...
			this.pictureAndSoundRadioButton.Text = "Picture &and Sound";
			...
			this.mediumRadioButton.Location = new System.Drawing.Point(29, 62);
			...
			this.easyRadioButton.Location = new System.Drawing.Point(29, 39);
			...
			this.hardRadioButton.Location = new System.Drawing.Point(29, 85);
			...
			this.label5.Text = "Entire name must match.  Punctuation, case, and spaces are considered.";
			// 
			// label4
			// 
			...
			this.label4.Text = "Entire name must match.  Punctuation, case, and spaces are ignored.";
			// 
			// label3
			// 
			...
			this.label3.Text = "Correct answer on last name or species.  Punctuation, case, and spaces are ignore" +
    "d.";
			// 
			// label1
			// 
			...
			this.label1.Text = "How difficult do you want your fill in the blank questions to be?";
			// 
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.getItRightRadioButton);
			this.groupBox3.Controls.Add(this.oneTryRadioButton);
			this.groupBox3.Location = new System.Drawing.Point(5, 175);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new System.Drawing.Size(548, 47);
			this.groupBox3.TabIndex = 2;
			this.groupBox3.TabStop = false;
			this.groupBox3.Text = "Answer Options";
			// 
			// oneTryRadioButton
			// 
			this.oneTryRadioButton.AutoSize = true;
			this.oneTryRadioButton.Location = new System.Drawing.Point(29, 19);
			this.oneTryRadioButton.Name = "oneTryRadioButton";
			this.oneTryRadioButton.Size = new System.Drawing.Size(81, 17);
			this.oneTryRadioButton.TabIndex = 0;
			this.oneTryRadioButton.TabStop = true;
			this.oneTryRadioButton.Text = "&One try only";
			this.oneTryRadioButton.UseVisualStyleBackColor = true;
			// 
			...
			this.bandCodeRadioButton.Location = new System.Drawing.Point(238, 19);
			...
			this.Controls.Add(this.allowCluesCheckBox);
			this.Controls.Add(this.groupBox4);
			this.Controls.Add(this.groupBox1);
			this.Controls.Add(this.groupBox3);
			this.Controls.Add(this.groupBox2);
			this.Name = "QuizFillInTheBlankPanel";
			this.Size = new System.Drawing.Size(558, 380);
			this.Load += new System.EventHandler(this.QuizFillInTheBlankPanel_Load);
		...
		private System.Windows.Forms.RadioButton getItRightRadioButton;
		private System.Windows.Forms.GroupBox pictureTypeGroupBox;
		private System.Windows.Forms.CheckBox allowCluesCheckBox;
		...
		private System.Windows.Forms.RadioButton oneTryRadioButton;
