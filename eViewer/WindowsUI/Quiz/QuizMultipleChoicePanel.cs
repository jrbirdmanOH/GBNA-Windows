...
{
	public partial class QuizMultipleChoicePanel : QuizWizardPanel
    {
		[Browsable(false)]
		public override bool WizardEnabled
        {
            get
            {
                return QuizSettings.QuizType == QuizSettings.QuizTypes.MultipleChoice ? true : false;
            }
        ...
        public QuizMultipleChoicePanel() : base()
        {
            InitializeComponent();
        }
        ...
        private void QuizMultipleChoicePanel_Load(object sender, EventArgs e)
        {
			if (!DesignMode)
			{
				Initialize();
